...
V_model = Sequential()
V_model.add(Flatten(input_shape=env.observation_space.shape))
V_model.add(Dense(160))
...
mu_model = Sequential()
mu_model.add(Flatten(input_shape=env.observation_space.shape))
mu_model.add(Dense(160))
